...
public class TestBranchArrayVisitor {
  ...
  static Class ic = null;

  @BeforeClass
  public static void init() {
    try {
      ic = ClassTester.getInstrumentedTestClass();
      ClassAnalyzer.registerClass(ic.getName());
  ...
  @Test
  public void instrumentedClassIsInstrumented() throws ClassNotFoundException {
    ic = ClassTester.getInstrumentedTestClass();
    try {
      ic.getDeclaredMethod("__instrumentationInit");
    } catch (NoSuchMethodException e) {
      fail("Instrumented class has no instrumentation init method");
    }
  }
