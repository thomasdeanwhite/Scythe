...
public class InstrumentationProperties implements PropertySource {
    ...
    @Parameter(key = "active_mutant_file", description = "File containing IDs of active mutants for mutation testing", hasArgs = true, category = "Instrumentation")
    public static String ACTIVE_MUTANT_FILE = "";

    @Parameter(key = "visit_mutants", description = "Whether or not to use mutants generated by a mutant-generation tool", hasArgs = true, category = "Instrumentation")
