...
public class Agent{
   ...
   */
  private static final String RESOURCE = "/scytheagent.jar";
  ...
  protected static InputStream getResourceAsStream() {
    final InputStream stream = Agent.class.getResourceAsStream(RESOURCE);
    if (stream == null) {
  ...
  public static File extractToTempLocation() throws IOException {
    final File agentJar = File.createTempFile("scytheagent", ".jar");
